...
async def main_async() -> int:
    ...
    handoff_source=ROOT/"scripts"/"research"/"mobile_pixel_evidence"/"HANDOFF_FOR_KANADE.md"
    (OUT/"HANDOFF_FOR_KANADE.md").write_text(handoff_source.read_text(encoding="utf-8"),encoding="utf-8")
