...
CASES = {
    "maylynn_paint": {"company_name": "Maylynn Paint", "industry": "外壁塗装", "location": "福岡市", "truth": "外壁塗装・屋根・雨漏り・リフォームを相談できる地域の窓口。", "goal": "quote_request", "roles": ["hero_home_finish", "craft_handwork", "material_detail", "trust_consultation"]},
...
def build_input(company_id: str, case: dict) -> dict:
    ...
    evidence = [
        ...
        {"evidence_id": f"{company_id}-e-003", "evidence_type": "SERVICE_PROCESS", "evidence_strength": "E3_OPERATIONAL", "target_objections": ["O3_PROCESS"], "claim": "対応できる内容を確認してから次の案内へ進む。", "source": "approved-selection-manifest", "verification_status": "VERIFIED", "verification_date": "2026-09-16", "usage_status": "PRODUCTION_ELIGIBLE", "rights_status": "NOT_APPLICABLE", "blocking_status": "NON_BLOCKING", "placement_candidates": ["MIDDLE"]},
