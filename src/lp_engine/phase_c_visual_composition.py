...
body[data-issue74-profile="self-check-field"] main > .premium-scene:nth-child(3) .scene-layered{display:grid;grid-template-columns:minmax(0,.64fr) minmax(0,.36fr);align-items:stretch;min-height:420px}
body[data-issue74-profile="self-check-field"] main > .premium-scene:nth-child(3) .scene-layered-copy{position:static;grid-column:1;grid-row:1;align-self:center}
body[data-issue74-profile="self-check-field"] main > .premium-scene:nth-child(3) .scene-media{grid-column:2;grid-row:1;min-height:100%;border-radius:50% 0 0 50%}
...
@media (max-width:767px){body[data-issue77-f01="three"] main > .premium-scene:nth-child(3) .scene-layered{display:block;min-height:0}body[data-issue77-f01="three"] main > .premium-scene:nth-child(3) .scene-layered-copy{position:static;width:100%;max-width:none;min-width:0}body[data-issue77-f01="three"] main > .premium-scene:nth-child(3) .scene-layered-copy h1,body[data-issue77-f01="three"] main > .premium-scene:nth-child(3) .scene-layered-copy h2,body[data-issue77-f01="three"] main > .premium-scene:nth-child(3) .scene-layered-copy p{width:100%;max-width:100%;word-break:keep-all;overflow-wrap:normal;white-space:normal}body[data-issue77-f01="three"] main > .premium-scene:nth-child(3) .scene-media{min-height:280px;width:100%;margin-top:2rem}}
""",
    "baum": """
