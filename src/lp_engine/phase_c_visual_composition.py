...
@media (max-width:767px){body[data-issue77-f01="three"] main > .premium-scene .scene-layered{display:block;min-height:0}body[data-issue77-f01="three"] main > .premium-scene .scene-layered-copy{position:static;width:100%;max-width:none;min-width:0}body[data-issue77-f01="three"] main > .premium-scene .scene-layered-copy h1,body[data-issue77-f01="three"] main > .premium-scene .scene-layered-copy h2,body[data-issue77-f01="three"] main > .premium-scene .scene-layered-copy p{width:100%;max-width:100%;word-break:keep-all;overflow-wrap:normal;white-space:normal}body[data-issue77-f01="three"] main > .premium-scene .scene-media{min-height:280px;width:100%;margin-top:2rem}}
""",
    "baum": """
